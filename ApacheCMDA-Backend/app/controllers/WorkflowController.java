...
public class WorkflowController extends Controller {
    ...
    public static MyComment allComment;
    ...
    public WorkflowController(final WorkflowRepository workflowRepository,
        ...
        this.allComment = new MyComment();
        MyComment negativeComment = new MyComment();
        MyComment commonComment = new MyComment();
        MyComment hotComment = new MyComment();
        allComment.getSubComments().add(negativeComment);
        allComment.getSubComments().add(commonComment);
        allComment.getSubComments().add(hotComment);
    }
...
//        return ok(erro);
    ...
    public Result addComment(){
        try{
            ...
            allComment.getSubComments().add(new MyComment("commonComment", comment));
